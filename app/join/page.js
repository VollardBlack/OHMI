    ...
    <>
      ...
      <section style={{ background: 'var(--maroon)', borderBottom: '1px solid #1e1e1e', padding: '60px 0 48px' }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14, lineHeight: 1.8, maxWidth: '52ch', marginTop: 8 }}>
          ...
          <div className="container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 32, alignItems: 'start' }}>
            ...
            <div>
              ...
              <div className="form-group">
                ...
                <span style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 4 }}>Leave blank if you were approached by OHMI directly.</span>
              </div>
              ...
              <p style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 12, lineHeight: 1.7 }}>
